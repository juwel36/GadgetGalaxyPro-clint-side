...
const Banner = () => {
  return (
    <div className=''>
      <div className='bg-red-700 flex flex-col lg:flex-row justify-center items-center rounded-lg'>
<div className='lg:w-1/2 lg:pl-10'>
<h1 className='text-5xl text-white font-semibold font-mono'>Elevate Your Lifestyle <br /> with Electronics</h1>
<p className='mt-4 text-white'>Discover the future of electronics in one place .
